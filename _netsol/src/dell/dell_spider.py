...
def getProductDetails(mapping, browser):
    ...
    csvWriter.writerow(["#ItemNumber", "NEW_ITEM-VENDOR", "NEW_ITEM-DESCRIPTION", "NEW_ITEM-MATNR", "NEW_ITEM-MATGROUP", "NEW_ITEM-UNIT", "NEW_ITEM-PRICE", 
          ...
          "NEW_ITEM-CUST_FIELD1", "NEW_ITEM-CUST_FIELD4", "NEW_ITEM-CUST_FIELD5", "ITEM-GREEN_ITEM", "ITEM-BUNDLE_NO",
    ...
    for id in idDict.keys(): 
        try:
	        ...
	        "", "", "", version, manufName, licenseQty, "", "", "", "", "", manufName, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""]
...
if __name__ == "__main__":
    ...
    for categoryPat, num in [("ctl00_ASAPHolderMain_ucEndecaLeftpane_rpcTopBrands_ctl%s_lnkNavItem", 639)]:
    	# skip spidering-for-ids: for i in range(1):
        for i in range(num):
            try:
    ...
    print "running readMappingFile()"
    mapping = readMappingFile()
    print "running getProductDetails()"
