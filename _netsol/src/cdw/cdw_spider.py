...
class MySpider(CrawlSpider):
    ...
    allowed_domains = ['www.cdwg.com', 'static.cdwg.com']
    start_urls = ['https://www.cdwg.com/Eprocurement/xCBL/RoundTripHandoff.aspx?USERNAME=Northrop&PASSWORD=0308f9ded3&HOOK_URL=http://www.smartoci.com']
