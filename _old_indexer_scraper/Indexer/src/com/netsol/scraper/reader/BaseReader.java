...
public class BaseReader
{
    ...
    public void writeCSVline(CSVWriter out, ItemValuesBean itemBean, int itemNo) {
        try {
            ...
            String[] entries = {Integer.toString(itemNo), itemBean.getDescription(), itemBean.getItemMatGroup(), "EA", itemBean.getPrice(), "USD", itemBean.getItemNo(), itemBean.getItemLongText1(), itemBean.getImage(), itemBean.getUrl(), itemBean.getItemManufactMat(), itemBean.getItemLeadTime()};
            ...
            SecurityException, NoSuchMethodException
    {
    	...
    	String[] entries = "#ItemNumber,NEW_ITEM-DESCRIPTION,NEW_ITEM-MATGROUP,NEW_ITEM-UNIT,NEW_ITEM-PRICE,NEW_ITEM-CURRENCY,NEW_ITEM-VENDORMAT,NEW_ITEM-LONGTEXT,NEW_ITEM-IMAGE,NEW_ITEM-URL,NEW_ITEM-MANUFACTMAT,NEW_ITEM-LEADTIME".split(",");
    ...
    private List<File> getFiles(File directory, Logger logger, List<File>
            returnList)
    {
        System.out.println("getFiles: " + directory.getPath());
        try
        {
